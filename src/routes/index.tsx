  ...
  head: () => ({
    meta: [
      { title: "EpiGlobe — Global Disease Intelligence" },
      {
        name: "description",
        content:
          "Real-time interactive 3D globe for tracking global disease outbreaks and spread predictions.",
      },
    ],
  }),
});
...
function Index() {
  type GlobeComponentType = typeof import("@/components/epiglobe/GlobeView").default;
