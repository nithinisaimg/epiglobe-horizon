...
export const DISEASES: DiseaseDef[] = [
  {
    id: 'covid19', name: 'COVID-19', short: 'COVID-19', era: 'current', year: '2019-present',
    R0: 3.0, transmission: 'Respiratory droplets / aerosol',
    regionWeight: { 'North America': 1, 'Europe': 1, 'South America': 0.9, 'Asia': 0.95, 'Africa': 0.6, 'Oceania': 0.7, 'Australia-Oceania': 0.7 },
    globalPrevalence: 0.09, cfr: 0.01, beta: 0.3, gamma: 0.1,
    description: 'SARS-CoV-2 coronavirus causing respiratory illness. Pandemic declared March 2020.',
    severity: { low: 1, moderate: 100_000, high: 500_000, critical: 1_000_000, extreme: 5_000_000 },
  },
  {
    id: 'influenza', name: 'Seasonal Influenza', short: 'Flu', era: 'current', year: 'Annual',
    R0: 1.3, transmission: 'Respiratory droplets',
    regionWeight: { 'North America': 1, 'Europe': 1, 'South America': 0.7, 'Asia': 0.9, 'Africa': 0.5, 'Oceania': 0.8, 'Australia-Oceania': 0.8 },
    globalPrevalence: 0.05, cfr: 0.001, beta: 0.22, gamma: 0.18,
  ...
  {
    id: 'mpox', name: 'Mpox (Monkeypox)', short: 'Mpox', era: 'recent', year: '2022-present',
    R0: 1.8, transmission: 'Close contact / lesions',
    regionWeight: { 'Africa': 1, 'Europe': 0.6, 'North America': 0.5, 'South America': 0.4, 'Asia': 0.3, 'Oceania': 0.2, 'Australia-Oceania': 0.2 },
    globalPrevalence: 0.0002, cfr: 0.03, beta: 0.15, gamma: 0.08,
  ...
  {
    id: 'dengue', name: 'Dengue Fever', short: 'Dengue', era: 'current', year: 'Ongoing',
    R0: 2.5, transmission: 'Aedes mosquito vector',
    regionWeight: { 'South America': 1, 'Asia': 1, 'Africa': 0.8, 'North America': 0.3, 'Oceania': 0.6, 'Australia-Oceania': 0.6, 'Europe': 0.1 },
    globalPrevalence: 0.02, cfr: 0.005, beta: 0.2, gamma: 0.12,
  ...
  {
    id: 'malaria', name: 'Malaria', short: 'Malaria', era: 'current', year: 'Ongoing',
    R0: 5.0, transmission: 'Anopheles mosquito vector',
    regionWeight: { 'Africa': 1, 'Asia': 0.6, 'South America': 0.5, 'Oceania': 0.4, 'Australia-Oceania': 0.2, 'North America': 0.05, 'Europe': 0.02 },
    globalPrevalence: 0.03, cfr: 0.003, beta: 0.35, gamma: 0.07,
  ...
  {
    id: 'ebola', name: 'Ebola Virus', short: 'Ebola', era: 'recent', year: '1976-present',
    R0: 1.8, transmission: 'Bodily fluids contact',
    regionWeight: { 'Africa': 1, 'Europe': 0.05, 'North America': 0.02, 'Asia': 0.02, 'South America': 0.01, 'Oceania': 0.01, 'Australia-Oceania': 0.01 },
    globalPrevalence: 0.00005, cfr: 0.50, beta: 0.18, gamma: 0.1,
  ...
  {
    id: 'sars', name: 'SARS', short: 'SARS', era: 'past', year: '2002-2003',
    R0: 2.5, transmission: 'Respiratory droplets',
    regionWeight: { 'Asia': 1, 'North America': 0.4, 'Europe': 0.2, 'Oceania': 0.1, 'Australia-Oceania': 0.1, 'Africa': 0.02, 'South America': 0.02 },
    globalPrevalence: 0.00001, cfr: 0.096, beta: 0.25, gamma: 0.1,
  ...
  {
    id: 'h1n1', name: 'H1N1 Swine Flu', short: 'H1N1', era: 'past', year: '2009-2010',
    R0: 1.5, transmission: 'Respiratory droplets',
    regionWeight: { 'North America': 1, 'Europe': 0.8, 'South America': 0.7, 'Asia': 0.7, 'Africa': 0.4, 'Oceania': 0.6, 'Australia-Oceania': 0.6 },
    globalPrevalence: 0.15, cfr: 0.0002, beta: 0.2, gamma: 0.13,
  ...
  {
    id: 'spanish_flu', name: 'Spanish Flu (H1N1 1918)', short: 'Spanish Flu', era: 'past', year: '1918-1920',
    R0: 2.0, transmission: 'Respiratory droplets',
    regionWeight: { 'Europe': 1, 'North America': 1, 'Asia': 0.9, 'Africa': 0.7, 'South America': 0.7, 'Oceania': 0.6, 'Australia-Oceania': 0.6 },
    globalPrevalence: 0.33, cfr: 0.025, beta: 0.28, gamma: 0.12,
    description: 'Deadliest pandemic in modern history. ~500M infected, ~50M deaths.',
    severity: { low: 1, moderate: 100_000, high: 1_000_000, critical: 5_000_000, extreme: 20_000_000 },
  },
  {
    id: 'plague', name: 'Black Death (Plague)', short: 'Plague', era: 'past', year: '1347-1351',
    R0: 4.5, transmission: 'Flea / rodent vector',
    regionWeight: { 'Europe': 1, 'Asia': 0.9, 'Africa': 0.7, 'North America': 0, 'South America': 0, 'Oceania': 0, 'Australia-Oceania': 0 },
    globalPrevalence: 0.3, cfr: 0.6, beta: 0.4, gamma: 0.08,
    description: 'Yersinia pestis bubonic plague. Killed 30-50% of Europe\'s population.',
    severity: { low: 1, moderate: 50_000, high: 500_000, critical: 2_000_000, extreme: 10_000_000 },
  },
  {
    id: 'smallpox', name: 'Smallpox', era: 'past', short: 'Smallpox', year: 'Eradicated 1980',
    R0: 6.0, transmission: 'Airborne',
    regionWeight: { 'Europe': 1, 'Asia': 1, 'Africa': 0.9, 'North America': 0.8, 'South America': 0.8, 'Oceania': 0.5, 'Australia-Oceania': 0.5 },
    globalPrevalence: 0.1, cfr: 0.3, beta: 0.5, gamma: 0.1,
...
export function synthesizeCountryData(
  ...
  return base.map(c => {
    ...
    const todayCases = Math.round(active * (0.005 + hashStr(`t-${disease.id}-${c.country}`) * 0.02));
